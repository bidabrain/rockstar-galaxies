CFLAGS=-m64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D_BSD_SOURCE -D_POSIX_SOURCE -D_POSIX_C_SOURCE=200809L -D_SVID_SOURCE -D_DARWIN_C_SOURCE -Wall -fno-math-errno -fPIC -I/opt/ohpc/pub/apps/libtirpc/include/tirpc -L/opt/ohpc/pub/apps/libtirpc/lib
LDFLAGS=-shared
OFLAGS = -lm -O3 -std=c99 -ltirpc
...
DIST_FLAGS =
HDF5_FLAGS = -DH5_USE_16_API -lhdf5 -DENABLE_HDF5 -I/opt/local/include -L/opt/local/lib -I/opt/ohpc/pub/libs/gnu12/hdf5/1.14.0/include -L/opt/ohpc/pub/libs/gnu12/hdf5/1.14.0/lib
